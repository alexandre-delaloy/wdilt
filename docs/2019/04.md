...
Also, I discovered [shellcheck](https://www.shellcheck.net/), a **shell/bash debugger**.
...
Today I discovered [Chart.js](https://www.chartjs.org/samples/latest/) & [react-chartjs](https://github.com/reactjs/react-chartjs), to made **unknown-genius**.
...
Today I discovered [fullPage.js](https://alvarotrigo.com/fullPage) to made **horizontal slide scrolling**.
